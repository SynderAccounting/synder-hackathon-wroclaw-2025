"""Amazon API Mock Server

A Flask server that mocks the Amazon API.
...
def get_order():
    ...
    # Convert to Amazon-specific order
    ...
    # Return as JSON
    order_json = json.loads(amazon_order.to_json())
...
def health():
    ...
    return jsonify({"status": "healthy", "service": "Amazon API Mock"}), 200
